...
text http://localhost:8080/smart-campus-api/api/v1 
...
bash curl http://localhost:8080/smart-campus-api/api/v1 

### 2. Get all rooms

bash curl http://localhost:8080/smart-campus-api/api/v1/rooms 

### 3. Create a room

bash curl -X POST http://localhost:8080/smart-campus-api/api/v1/rooms \ -H "Content-Type: application/json" \ -d '{"id":"LT-01","name":"Lecture Theatre 01","capacity":120}' 

### 4. Get all sensors

bash curl http://localhost:8080/smart-campus-api/api/v1/sensors 

### 5. Filter sensors by type

bash curl "http://localhost:8080/smart-campus-api/api/v1/sensors?type=Temperature" 

### 6. Create sensor with invalid roomId

bash curl -X POST http://localhost:8080/smart-campus-api/api/v1/sensors \ -H "Content-Type: application/json" \ -d '{"id":"HUM-999","type":"Humidity","status":"ACTIVE","currentValue":55.0,"roomId":"FAKE-ROOM"}' 

### 7. Add reading

bash curl -X POST http://localhost:8080/smart-campus-api/api/v1/sensors/TEMP-001/readings \ -H "Content-Type: application/json" \ -d '{"value":27.8}' 
...
json {   "links": {     "rooms": "/api/v1/rooms",     "sensors": "/api/v1/sensors"   } } 
...
### 5.2 Why 422 Rather Than 404 for an Invalid Room Reference
...
json {   "status": 500,   "error": "Internal Server Error",   "message": "An unexpected error occurred. Please try again later." } 

### 5.5 Why Filters Are Better Than Manual Logging
